...
- [Detecting Semantic Similarity in Questions](#detecting-semantic-similarity-in-questions)
	...
	- [Architectures Used](#architectures-used)
		...
		- [Siamese Architecture](#siamese-architecture)
			- [Convolutional Siamese Network](#convolutional-siamese-network)
			- [LSTM Siamese Network](#lstm-siamese-network)
	- [Results](#results)
	- [Analysis](#analysis)
...
<table style="padding:10px">
    <tr>
        <td style="text-align: center"> Balanced Data </td>
        <td style="text-align: center"> Unbalanced Data </td>
    </tr>
    <tr>
        <td>
			<p align="center">
				<img src="plots/balanced_lstm_acr.png" height='250px'/><br>
				<code>Variation of accuracy with epoch</code>
			</p>
        </td>
        <td>
			<p align="center">
    ...
    <tr>
        <td>
			<p align="center">
				...
				<code>Variation of loss with epoch</code>
			</p>
        </td>
        <td>
			<p align="center">
